      ...
      <React.Fragment>
        ...
        >
          <h2 className=" text-gray-600 font-semibold">
            Register information for the role of Japanese instructor
          </h2>
          <div className="">
            <h3 className="-mb-2 mt-2 font-semibold text-red-600">
              [Vietnamese]
            </h3>
            <label className="block mt-4">
              <div className="flex -mb-3">
                <span className="block font-medium">About Me</span>
            ...
            <label className="block mt-4">
              <div className="flex -mb-3">
                <span className="block font-medium">
                  Highest School (University, Institutes, etc) where you
                  graduated
                </span>
                <b className="text-red-600 ml-1"> (*)</b>
              </div>
              <Input
                name={`infos_lang[vi][universities]`}
                type={`text`}
            ...
            <label className="block mt-4">
              <div className="flex -mb-3">
                <span className="block font-medium">Areas of expertise</span>
                <b className="text-red-600 ml-1"> (*)</b>
              </div>
              <Textarea
          ...
          <div className="">
            ...
            <label className="block mt-4">
              ...
              <Input
                name={`infos_lang[en][universities]`}
                type={`text`}
          ...
          <div className="">
            ...
            <label className="block mt-4">
              ...
              <Input
                name={`infos_lang[jp][universities]`}
                type={`text`}
            ...
            label={
              <>
                <span
                  ...
                  name={`infos[video_url]`}
                  type={`file`}
                  value={user?.infos?.video_url}
                >
