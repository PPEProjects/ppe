    ...
    <form onSubmit={(e) => userSAVE(e)} className="w-full my-10">
      <main className="w-full max-w-3xl mx-auto rounded">
        ...
        >
          ...
          <label className="block mt-4">
            <div className="flex -mb-3">
              <span className="block font-medium">Email (login)</span>
              <b className="text-red-600 ml-1"> (*)</b>
            </div>
            <Input
              onChange={(value) => userCHECK(value)}
              name={`email`}
              type={`email`}
            />
          </label>
          ...
          <label className="block mt-4">
            <div className="flex -mb-3">
              <span className="block font-medium">Password (login)</span>
              <b className="text-red-600 ml-1"> (*)</b>
            </div>
        ...
        {types["Japanese instructor"] && (
          <UsersFormTypeInstructor show={show} />
        )}
