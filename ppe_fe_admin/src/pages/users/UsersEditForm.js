...
const UsersEditForm = () => {
    ...
    return (
        <form onSubmit={(e) => userSAVE(e)} className="w-full my-10">
            ...
            <main
                className="w-full max-w-3xl mx-auto rounded max-h-64 overflow-y-auto my-3
      "
            >
                <section
                    className={`${
                ...
                >
                    ...
                    <>
                        <label className="block mt-4">
                            <div className="flex -mb-3"><span
                                ...
                                className="text-red-600 ml-1"> (*)</b></div>
                            <Input name={`infos_lang[vi][name]`} value={user?.infos_lang?.vi?.name}/>
                        </label>
                        <label className="block mt-4">
                            <div className="flex -mb-3"><span
                                className="block font-medium">Full name in English</span><b
                                className="text-red-600 ml-1"> (*)</b></div>
                            <Input name={`infos_lang[en][name]`} value={user?.infos_lang?.en?.name}/>
                        </label>
                        <label className="block mt-4">
                            <div className="flex -mb-3"><span className="block font-medium">Full name in Japanese</span><b
                                className="text-red-600 ml-1"> (*)</b></div>
                            <Input name={`infos_lang[jp][name]`} value={user?.infos_lang?.jp?.name}/>
                        </label>
                    </>
                    }
                    ...
                    />
                    <label className="block mt-4">
                        <div className="flex -mb-3"><span className="block font-medium">Avatar</span><b
                            className="text-red-600 ml-1"> (*)</b></div>
                ...
                {types['Japanese instructor'] && <UsersFormTypeInstructor show={show} user={user}/>}
                {types[`Japanese learner`] && <UsersFormTypeJapanese show={show} user={user}/>}
                {types[`IT project member`] && <UsersFormTypeProjects show={show} user={user}/>}
            </main>
            <FormFooter
