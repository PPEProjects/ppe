...
class CoursesFormDescription extends Component {
  constructor(props) {
    super(props);
    this.state = {
      status: ``,
          ...
          {inputs.map((input, key) => (
            <section className="mt-3" key={key}>
              ...
              <textarea
                ...
                className="text-sm border border-gray-400 hover:border-gray-500 w-full h-56 px-3 py-1 mt-2 rounded-md outline-none focus:border-blue-700 "
...
export default CoursesFormDescription;
