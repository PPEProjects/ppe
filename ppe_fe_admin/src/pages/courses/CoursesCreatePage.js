        ...
        <form onSubmit={(e) => courseSAVE(e)} className="w-full my-10">
            <main className="w-full max-w-3xl mx-auto rounded">
                ...
                >
                    ...
                    <div className="flex items-center justify-between">
                        <label className="block mt-4 w-full">
                            <div className="flex -mb-2"><span className="block font-medium">Display language</span>
                                <b className="text-red-600 ml-1"> (*)</b></div>
                            <Select
                                name={`language`}
                    ...
                    <label className="block mt-4">
                        <div className="flex -mb-3"><span className="block font-medium">Name of the course</span><b
                ...
                >
                    ...
                    <label className="block mt-4">
                        <div className="flex -mb-3"><span className="block font-medium">Time length, Day and Time of the course</span><b
                            className="text-red-600 ml-1"> (*)</b></div>
                        <Input name={`more[time]`} type={`text`} placeholder="4 months, Mon-Wed-Fri, 7:00AM~8:30AM"/>
                    </label>
                    <label className="block mt-4">
                ...
                >
                    ...
                    />
                    <label className="block mt-4">
                        <div className="flex -mb-3"><span className="block font-medium">Instructors</span><b
                            className="text-red-600 ml-1"> (*)</b></div>
                    </label>
                    <Checkbox
                        name={`teachers`}
