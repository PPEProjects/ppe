            ...
            <aside className="w-full">
                <div className="grid grid-cols-12 gap-4 mx-6 ">
                  ...
                  /> */}
                        ...
                        <section
                            className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-300 py-3 mt-4 ">
                            <div>
                                ...
                                <div className=" grid grid-cols-12 gap-3 mx-3 ">
                                    {postsSearch.map((post, key) => (
                                        <div className="col-span-3" key={key}>
                                            ...
                                            >
                        <span
                            className="absolute left-0 top-0 z-10 mt-2 ml-2 text-xs rounded-sm px-1 bg-black-50 text-white h-4 flex items-center">
                          {post.language}
                        </span>
                                                <button
                                                    type="button"
