...
const CommentsDetailPage = () => {
  ...
  const { isShow, mode, comment, post } = useSelector(detailsSelector);
                    ...
                    {mode === `table` && (
                      <table className="table-auto text-sm border-gray-400 border">
                        ...
                        <tbody className="border-gray-400 border">
                          {Object.entries(comment).map(([key, item], i) => (
