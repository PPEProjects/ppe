            ...
            <div class="flex flex-wrap mb-2 ">
              <div class="w-full md:w-1/3 md:text-left px-3 mb-2 md:mb-0 pb-3 sm:pb-0">
                ...
                <p>
                  ...
                  <i class="material-icons font-bold text-gray-200 mr-1">location_on</i>23 Lương Thúc Kỳ, Hòa Hải, Ngũ Hành Sơn, Đà Nẵng.<br />
                  </a>
                  </div>

                  <div className=" ">
                    <a href="tel:0962414125" className="flex">
                  <i class="material-icons font-bold text-gray-200 mr-1">phone</i> <p className="ml-1"> 0962414125</p> .<br />
                    </a>
                  </div>
                  <div className=" ">
                    <a href="https://www.facebook.com/ParacelProjectEducation" className="flex items-center	mb-4">
                  <i class="material-icons font-bold text-gray-200 mr-1 text-3xl mt-1">facebook</i> <p className="mt-2">https://www.facebook.com/ParacelProjectEducation</p><br />
                    </a>
                  </div>
                  ...
                  <i class="material-icons font-bold text-gray-200 mr-1">location_on</i>〒108‐0014　東京都港区芝5－20－14三田鈴木ビル６Ｆ.<br />
                  </a>
                  </div>
                  <div className="">
                  <a href="tel:7021601245" className="flex">
                  <i class="material-icons font-bold text-gray-200 mr-1">phone</i> <p>7021601245</p> .<br />
                  </a>
                  </div>
                  <div className=" ">
                    <a href="https://www.facebook.com/ParacelProjectEducation" className="flex items-center	">
                  <i class="material-icons font-bold text-gray-200 mr-1 text-3xl mt-1">facebook</i> <p className="mt-2">https://www.facebook.com/ParacelProjectEducation</p>
                    </a>
                  </div>
                  <br />
                ...
                {users_life_support.map((user, key) => (
                  <div key={key}>
                       ...
                       { [user.name].length !== 0 &&  [user.name].length !== "" &&
              ...
              <div class="w-full md:w-1/3 md:text-left px-3 sm:px-1 mb-2 md:mb-0 pb-3 sm:pb-0">
                ...
                <p class="pt-6 flex items-center">
                  <a class="footer link pr-4" href="https://twitter.com/share?text=&url=http://ppe.edu.vn/Course/7" target="_blank"
                >
                  <svg
                  ...
                  <a class="footerlink pr-4"  target = " _blank " href = "https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fppe.edu.vn%2FCourse%2F7&src=sdkpreparse "
              >
                <svg
                  className="inline fill-current text-brand-ondark w-6 h-6"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  ...
                  <a class="footerlink pr-4" href="https://www.youtube.com/channel/UClK5jW8wARTvwpTSllLxEvg">
                    <svg
