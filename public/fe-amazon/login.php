    ...
    <main class="w-full max-w-md mx-auto px-4">
        <form action="" class="p-3 border border-gray-400 rounded mt-3">
            ...
            <label class="block mt-3">
                <span class="block text-gray-700">Email (phone for mobile accounts)</span>
                <input
                    type="text"
            ...
            <div class="text-center mt-3">
                ...
                <button
                    type="button"
                    class="bg-indigo-700 text-white h-10 w-32 rounded hover:opacity-75 "
                >
        ...
        <div class="border-t border-gray-400 relative mt-6">
            <span class="absolute absolute-y absolute-x top-0 -mt-3 bg-white px-3 text-sm text-gray-800">New to PPE?</span>
        </div>
        <div class="text-center mt-6 clear-both">
            <!-- button-bg-blue -->
            <a
                href="register.php"
                class="bg-gray-100 text-gray-800 h-10 px-4 rounded hover:opacity-75 border flex items-center justify-center"
            >
                <span class="">Create your PPE account</span>
            </a>
        </div>
    </main>
</body>
