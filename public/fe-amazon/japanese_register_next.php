                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="lg:col-span-8 col-span-12 lg:mt-6 mt-4 ">
                        ...
                        <form action="/" class="p-2 bg-yellow-200 mt-3">
                            ...
                            <!-- input-border -->
                            <label class="block mt-3">
                                <span class="block">Facebook ID</span>
                                <input
                                    type="text"
                                    class="border border-gray-400 h-10 w-full px-3 mt-2 rounded"
                                    placeholder="Enter here ..."
                            ...
                            <div class="flex items-center mt-4 ">
                                ...
                                <!-- button-bg-white -->
                                <a href="japanese_register_finished.php"
                                        class="bg-gray-200 text-indigo-700 h-10 w-full rounded hover:opacity-75 border border-indigo-700 flex items-center justify-center ml-3"
                                >
