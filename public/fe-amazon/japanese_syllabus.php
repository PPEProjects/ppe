            ...
            <section class="w-full max-w-screen-xl mx-auto ">
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="lg:col-span-8 col-span-12 lg:mt-6 mt-4 ">
                        <h3 class="text-2xl font-semibold mb-8">Syllabus of <span class="text-gray-600">N4</span></h3>
                        <div class="">
                            <?php foreach($japanese_syllabus as $key => $val){?>
                            <h3 class="text-xl my-3 text-indigo-700 font-semibold">Topic : <?= $val['title'] ?></h3>
                            <ul class="list-disc pl-8 leading-7">
                                <?php foreach($val['lists'] as $key1 => $val1){?>
                                    <li class=""><?= $val1 ?></li>
                                <?php }?>
                            </ul>
                            <?php }?>
