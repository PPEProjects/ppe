            ...
            <section class="w-full max-w-screen-xl mx-auto ">
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="lg:col-span-8 col-span-12 lg:mt-6 mt-4 ">
                        ...
                        <form action="/" class="p-2 bg-yellow-200 mt-3">
                            <!-- input-border -->
                            <label class="block ">
                                <span class="block">Day to join</span>
                                <div class="mt-1 -mx-2 ml-3">
                                    <!-- button-bg-blue-text-icon -->
                                    <button type="button" class="bg-transparent h-8 px-2 rounded hover:opacity-75 flex items-center focus:outline-none">
                                        <i class="material-icons">radio_button_unchecked</i>
                                        <span class="ml-2">Monday, Wednesday, Friday</span>
                                    </button>
                                    <!-- button-bg-blue-text-icon -->
                                    <button type="button" class="bg-transparent h-8 px-2 rounded hover:opacity-75 flex items-center focus:outline-none">
                                        <i class="material-icons">radio_button_unchecked</i>
                                        <span class="ml-2">Tuesday, Thursday, Saturday</span>
                                    </button>
                                </div>
                            </label>
                            <!-- input-border -->
                            <label class="block mt-3">
                                <span class="block">Time to join</span>
                                <div class="mt-1 -mx-2 ml-3">
                                    <!-- button-bg-blue-text-icon -->
                                    <button type="button" class="bg-transparent h-8 px-2 rounded hover:opacity-75 flex items-center focus:outline-none">
                                        <i class="material-icons">radio_button_unchecked</i>
                                        <span class="ml-2">7:00~8:30 AM</span>
                                    </button>
                                    <!-- button-bg-blue-text-icon -->
                                    <button type="button" class="bg-transparent h-8 px-2 rounded hover:opacity-75 flex items-center focus:outline-none">
                                        <i class="material-icons">radio_button_unchecked</i>
                                        <span class="ml-2">9:00~10:30 AM</span>
                                    </button>
                                    <!-- button-bg-blue-text-icon -->
                                    <button type="button" class="bg-transparent h-8 px-2 rounded hover:opacity-75 flex items-center focus:outline-none">
                                        <i class="material-icons">radio_button_unchecked</i>
                                        <span class="ml-2">15:00~16:30 PM</span>
                                    </button>
                                    <!-- button-bg-blue-text-icon -->
                                    <button type="button" class="bg-transparent h-8 px-2 rounded hover:opacity-75 flex items-center focus:outline-none">
                                        <i class="material-icons">radio_button_unchecked</i>
                                        <span class="ml-2">19:30~21:00 PM</span>
                                    </button>
                                </div>
                            </label>
                            ...
                            <div class="flex items-center mt-4 ">
                                <!-- button-bg-white-icon -->
                                <a href="japanese_register_next.php"
                                   class="bg-white text-gray-800 h-10 w-32 rounded hover:opacity-75 hover:bg-gray-200 border border-gray-400 flex items-center justify-center"
                                >
                                    <i class="material-icons">arrow_back</i>
                                    <span class="uppercase ml-2">back</span>
                                </a>
                                ...
                                <button
                                        type="button"
                                        class="bg-indigo-700 text-white h-10 w-full rounded hover:opacity-75 flex items-center justify-center ml-3"
                                >
